// src/screens/admin/administrar_asistencia_usuario.js
...
export default function AdministrarAsistenciaUsuarioScreen({ navigation }) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      <Text style={[styles.title, { color: theme.text }]}>👥 Seleccionar usuario</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity
            ...
            onPress={() =>
              navigation.navigate("AdministrarAsistencia", { dni: item.dni })
            }
          >
